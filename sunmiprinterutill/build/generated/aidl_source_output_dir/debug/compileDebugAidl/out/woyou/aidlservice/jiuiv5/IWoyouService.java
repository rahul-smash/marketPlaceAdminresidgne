...
public interface IWoyouService extends android.os.IInterface
{
  ...
  public static class Default implements woyou.aidlservice.jiuiv5.IWoyouService
  {
    ...
    @Override public void commitPrint(com.ahmedelsayed.sunmiprinterutill.trans.TransBean[] transbean, woyou.aidlservice.jiuiv5.ICallback callback) throws android.os.RemoteException
    {
    }
  ...
  public static abstract class Stub extends android.os.Binder implements woyou.aidlservice.jiuiv5.IWoyouService
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        {
          data.enforceInterface(descriptor);
          com.ahmedelsayed.sunmiprinterutill.trans.TransBean[] _arg0;
          _arg0 = data.createTypedArray(com.ahmedelsayed.sunmiprinterutill.trans.TransBean.CREATOR);
          woyou.aidlservice.jiuiv5.ICallback _arg1;
          _arg1 = woyou.aidlservice.jiuiv5.ICallback.Stub.asInterface(data.readStrongBinder());
    ...
    static final int TRANSACTION_printColumnsString = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
  ...
  public void commitPrint(com.ahmedelsayed.sunmiprinterutill.trans.TransBean[] transbean, woyou.aidlservice.jiuiv5.ICallback callback) throws android.os.RemoteException;
