...
public class CanceledOrdersFragment extends Fragment {
    ...
    public static Fragment newInstance(Context context) {
        return Fragment.instantiate(context,
                CanceledOrdersFragment.class.getName());
    }
                ...
                if (getOrdersModel.getSuccess()) {
                    ...
                    if (getOrdersModel != null) {
                        if (getOrdersModel.getData().getOrders().size() > 0) {
                            ...
                            listCanceledOrders.setVisibility(View.GONE);
    ...
    public class CanceledOrdersAdapter extends BaseAdapter {
        ...
        public CanceledOrdersAdapter() {
            super();
        }

        public CanceledOrdersAdapter(Context context, List<OrdersListModel> list) {
