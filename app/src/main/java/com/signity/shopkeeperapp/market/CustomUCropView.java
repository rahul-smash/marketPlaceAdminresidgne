...
public class CustomUCropView extends FrameLayout {
    ...
    public CustomUCropView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomUCropView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        LayoutInflater.from(context).inflate(R.layout.ucrop_views, this, true);
...
/*        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ucrop_UCropView);
    ...
    public void resetCropImageView() {
        ...
        mGestureCropImageView = new CustomGestureCropImageView(getContext());
        setListenersToViews();
