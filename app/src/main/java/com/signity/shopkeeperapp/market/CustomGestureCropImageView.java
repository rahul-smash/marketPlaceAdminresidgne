...
/**
 * Created by Ketan Tetry on 6/2/20.
 */
public class CustomGestureCropImageView extends CropImageView {
    ...
    public CustomGestureCropImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomGestureCropImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setupGestureListeners() {
        mGestureDetector = new GestureDetector(getContext(), new CustomGestureCropImageView.GestureListener(), null, true);
        mScaleDetector = new ScaleGestureDetector(getContext(), new CustomGestureCropImageView.ScaleListener());
        mRotateDetector = new RotationGestureDetector(new CustomGestureCropImageView.RotateListener());
    }
